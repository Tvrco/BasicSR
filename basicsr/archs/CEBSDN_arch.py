...
class CEBSDN(nn.Module):
    def __init__(self, num_in_ch=3, num_feat=64, num_block=8, num_out_ch=3, upscale=4,
        ...
        self.B1 = CADB(in_channels=num_feat, out_channels=num_feat, conv=self.conv, p=p)
        self.B2 = CADB(in_channels=num_feat, out_channels=num_feat, conv=self.conv, p=p)
        self.B3 = CADB(in_channels=num_feat, out_channels=num_feat, conv=self.conv, p=p)
        self.B4 = CADB(in_channels=num_feat, out_channels=num_feat, conv=self.conv, p=p)
        self.B5 = CADB(in_channels=num_feat, out_channels=num_feat, conv=self.conv, p=p)
        self.B6 = CADB(in_channels=num_feat, out_channels=num_feat, conv=self.conv, p=p)
        self.B7 = CADB(in_channels=num_feat, out_channels=num_feat, conv=self.conv, p=p)
        self.B8 = CADB(in_channels=num_feat, out_channels=num_feat, conv=self.conv, p=p)
