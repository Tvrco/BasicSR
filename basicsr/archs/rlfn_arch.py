...
class ESA(nn.Module):
    ...
    def __init__(self, esa_channels, n_feats, conv):
        ...
        self.conv4 = conv(f, n_feats, kernel_size=1)  # conv1 剪枝
...
class RLFB(nn.Module):
    ...
    def __init__(self,
                 in_channels,  # 46 or 48
                 mid_channels=None, # 48
                 out_channels=None,
                 esa_channels=16):
        ...
        self.c3_r = conv_layer(mid_channels, in_channels, 3)  #剪枝

        self.c5 = conv_layer(in_channels, out_channels, 1)  # conv1 剪枝
