    ...
    for i in trange(num_len):
        ...
        for point in point_list:
            ...
            if count > 18 and count <= 22:
                cv2.polylines(img_full_boundary,[point_list[17:22]],False,(255,255,255),line_wight,lineType=cv2.LINE_AA)
            ...
            if count >= 23 and count <= 27:
                cv2.polylines(img_full_boundary,[point_list[22:27]],False,(255,255,255),line_wight,lineType=cv2.LINE_AA)
            ...
            if count >= 28 and count <= 31:
                cv2.polylines(img_full_boundary,[point_list[27:31]],False,(255,255,255),line_wight,lineType=cv2.LINE_AA)
            ...
            if count >= 32 and count <= 36:
                cv2.polylines(img_full_boundary,[point_list[31:36]],False,(255,255,255),line_wight,lineType=cv2.LINE_AA)
            ...
            if count >= 37 and count <= 42:
                cv2.polylines(img_full_boundary,[point_list[36:42]],False,(255,255,255),line_wight,lineType=cv2.LINE_AA)
            ...
            if count >= 43 and count <= 48:
                cv2.polylines(img_full_boundary,[point_list[42:48]],False,(255,255,255),line_wight,lineType=cv2.LINE_AA)
            ...
            if count >= 49 and count <= 55:
                cv2.polylines(img_full_boundary,[point_list[48:55]],False,(255,255,255),line_wight,lineType=cv2.LINE_AA)
                cv2.polylines(img_full_boundary,[point_list[54:61]],False,(255,255,255),line_wight,lineType=cv2.LINE_AA)
                cv2.polylines(img_full_boundary,[point_list[60:65]],False,(255,255,255),line_wight,lineType=cv2.LINE_AA)
...
# 保存路径
dest_dir_final = ops.join(root_dir,"celeb_fb128_lineaa")
