...
# 给定数据
methods = ['CEBSDN','VapSR','RLFN','IDN','IMDN','PAN','RFDN','BSRN','LKDN','FSRNet', 'FSR-GAN', 'DIC', 'DIC-GAN', 'MSFSR', 'MSFSR-GAN', 'BSRFSR', 'BSRFSR-GAN']
total_params = [319.02, 433.98,390.13,590.915,791.451,338.92,498.392,435.488,394.712,2153.93, 2153.93, 21803.21, 21803.21, 6343.53, 6343.53, 720.22, 720.22]  # Total params / 10^3
multi_adds = [78.48, 109.9,95.23,1045,203.05,734.36,122.0298,106.533,100.036,15847.52, 15847.52, 2982.84, 2982.84, 8530.11, 8530.11, 922.64, 922.64]  # Multi-adds / 10^6
psnr_values = [26.57, 24.72,24.39,23.76,23.93,24.63,24.41,24.64,24.62,26.31, 23.89, 27.28, 25.50, 26.22, 25.33, 27.06, 26.02]  # PSNR / dB
